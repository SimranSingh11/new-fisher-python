# Generated by Django 2.2.7 on 2019-11-06 18:27
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user_type', models.CharField(blank=True, choices=[('1', 'Admin'), ('2', 'SubAdmin'), ('3', 'Employee')], db_column='user_type', max_length=2, null=True)),
                ('dial_code', models.CharField(blank=True, db_column='dial_code', max_length=10, null=True)),
                ...
                ('forgot_pass_verify_code', models.CharField(blank=True, db_column='forgot_pass_verify_code', max_length=100, null=True)),
                ('forgot_pass_verify_code_date', models.DateTimeField(blank=True, db_column='forgot_pass_verify_code_date', null=True)),
